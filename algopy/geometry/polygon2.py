...
from algopy.geometry import (vector2, axisall, line2)
...
class Polygon2(object):
    ...
    .. caution::
        ...
        The length of :py:attr:`~algopy.geometry.polygon2.Polygon2.normals`
        is not necessarily the same as
        :py:attr:`~algopy.geometry.polygon2.Polygon2.points` or
        :py:attr:`~algopy.geometry.polygon2.Polygon2.lines`. It is only
    ...
    :vartype points: list of :class:`algopy.geometry.vector2.Vector2`

    :ivar lines: the ordered list of lines on this polygon
    :vartype lines: list of :class:`algopy.geometry.line2.Line2`

    :ivar normals: the unordered list of unique normals on this polygon
    :vartype normals: list of :class:`algopy.geometry.vector2.Vector2`

    :ivar center: the center of this polygon when unshifted.
    :vartype center: :class:`algopy.geometry.vector2.Vector2`
    """
    ...
    def __init__(self, points, suppress_errors = False):
        ...
        :type points: list of :class:`algopy.geometry.vector2.Vector2` or \
    ...
    def from_regular(cls, sides, length, start_rads = None, start_degs = None, center = None):
        ...
        .. code-block:: python
            ...
            from algopy.geometry import (vector2, polygon2)
            import math
        ...
        :type center: :class:`algopy.geometry.vector2.Vector2`
        :returns: the new regular polygon
        :rtype: :class:`algopy.geometry.polygon2.Polygon2`
    ...
    def from_rotated(cls, original, rotation, rotation_degrees = None):
        ...
        .. code-block:: python
            ...
            from algopy.goemetry import (vector2, polygon2)
            import math
        ...
        :type original: :class:`algopy.geometry.polygon2.Polygon2`
    ...
    def project_onto_axis(polygon, offset, axis):
        ...
        :type polygon: :class:`algopy.geometry.polygon2.Polygon2`
        :param offset: the offset of the polygon
        :type offset: :class:`algopy.geometry.vector2.Vector2`
        :param axis: the axis to project onto
        :type axis: :class:`algopy.geometry.vector2.Vector2`
        :returns: the projection of the polygon along the axis
        :rtype: :class:`algopy.geometry.axisall.AxisAlignedLine`
        """
    ...
    def contains_point(polygon, offset, point):
        ...
        :type polygon: :class:`algopy.geometry.polygon2.Polygon2`
        :param offset: the offset of the polygon
        :type offset: :class:`algopy.geometry.vector2.Vector2` or None
        :param point: the point to check
        :type point: :class:`algopy.geometry.vector2.Vector2`
    ...
    def find_intersection(poly1, poly2, offset1, offset2, find_mtv = True):
        ...
        :type poly1: :class:`algopy.geometry.polygon2.Polygon2`
        :param poly2: the second polygon
        :type poly2: :class:`algopy.geometry.polygon2.Polygon2`
        :param offset1: the offset of the first polygon
        :type offset1: :class:`algopy.geometry.vector2.Vector2` or None
        :param offset2: the offset of the second polygon
        :type offset2: :class:`algopy.geometry.vector2.Vector2` or None
        ...
        :rtype: (bool, bool, (:class:`numbers.Number`, :class:`algopy.geometry.vector2.Vector2`) or None)
        """
    ...
    def _create_link(pts):
        ...
        :type pts: list of :class:`algopy.geometry.vector2.Vector2`
        """
