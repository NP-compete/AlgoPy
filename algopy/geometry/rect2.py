...
from algopy.geometry import (vector2, line2, axisall, polygon2)
...
class Rect2(object):
    ...
    :vartype mincorner: :class:`algopy.geometry.vector2.Vector2`
    """
    ...
    def __init__(self, width, height, mincorner = None):
        ...
        :type mincorner: :class:`algopy.geometry.vector2.Vector2` or None
    ...
    def project_onto_axis(rect, axis):
        ...
        :type rect: :class:`algopy.geometry.rect2.Rect2`
    ...
    def _find_intersection_rects(cls, rect1, rect2, find_mtv = True):
        ...
        :type rect1: :class:`algopy.geometry.rect2.Rect2`
        :param rect2: second rectangle
        :type rect2: :class:`algopy.geometry.rect2.Rect2`
    ...
    def _find_intersection_rect_poly(cls, rect, poly, offset, find_mtv = True):
        ...
        :type rect: :class:`algopy.geometry.rect2.Rect2`
        :param poly: polygon
        :type poly: :class:`algopy.geometry.polygon2.Polygon2`
    ...
    def find_intersection(cls, *args, **kwargs):
        ...
        .. code-block:: python
            ...
            from algopy.geometry import (vector2, polygon2, rect2)
    ...
    def __repr__(self):
        ...
        .. code-block:: python
            ...
            from algopy.geometry import (vector2, rect2)
